...
class TodoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateTodoStatus = channel.unary_unary(
                ...
                _registered_method=True)
        self.AddTodoEntry = channel.unary_unary(
                '/todo.TodoService/AddTodoEntry',
                request_serializer=todo__pb2.Todo.SerializeToString,
                response_deserializer=todo__pb2.AddStatusTodo.FromString,
                _registered_method=True)
...
def add_TodoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddTodoEntry': grpc.unary_unary_rpc_method_handler(
                    servicer.AddTodoEntry,
                    request_deserializer=todo__pb2.Todo.FromString,
                    response_serializer=todo__pb2.AddStatusTodo.SerializeToString,
            ),
    }
...
class TodoService(object):
    ...
    def AddTodoEntry(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            todo__pb2.AddStatusTodo.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
